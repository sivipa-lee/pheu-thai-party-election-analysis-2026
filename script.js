...
function updateMapColors() {
    ...
    d3.selectAll(".tile-g").each(function() {
        ...
        el.select("rect")
            ...
            .attr("stroke-width", strokeWidth).attr("opacity", visible ? 1 : 0.12);
        el.select(".tile-text")
            .attr("fill", textColor).attr("opacity", visible ? 1 : 0.12);
    });
    renderStats();
}
